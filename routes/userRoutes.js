...
const {loginSchema,registerSchema,updateUserSchema} = require('../validator/userValidator');
    ...
    try {
        ...
        bcrypt.genSalt(10,(err,salt)=> {
         ...
         const user = await User.create({
            username,email,password:hash,isAdmin
         })
            })
...
route.put('/update/:id',async(req,res)=>{
    ...
    const { username,email,password,isAdmi} = req.body;
